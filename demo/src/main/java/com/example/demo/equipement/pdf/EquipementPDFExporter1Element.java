package com.example.demo.equipement.pdf;
...
public class EquipementPDFExporter1Element {

    private Equipement equipement;
    public EquipementPDFExporter1Element(Equipement equipement){
    ...
    private void writeTableData(PdfPTable table) throws BadElementException, IOException {
        ...
        table.addCell(new Phrase(equipement.getNom_equipement(),font));
        table.addCell(new Phrase(equipement.getMarque_equipement(),font));
        table.addCell(new Phrase(equipement.getDesignation_equipement(),font));
        table.addCell(new Phrase(equipement.getDescription_equipement(),font));
        table.addCell(new Phrase(String.valueOf(equipement.getPrix_equipement()),font));
        table.addCell(new Phrase(equipement.getDate_recu_equipement(),font));
        table.addCell(new Phrase(String.valueOf(equipement.getQuantite_equipement()),font));
    }
    ...
    public void export(HttpServletResponse response) throws DocumentException, IOException {
        ...
        Paragraph p = new Paragraph("\n\nInformations sur l'entretien de l'équipement "+equipement.getNom_equipement(), font);
        ...
        table.setWidthPercentage(100f);table.setWidths(new float[] {1.5f,1.5f,1.5f,1.5f,1.5f,2f,2f});

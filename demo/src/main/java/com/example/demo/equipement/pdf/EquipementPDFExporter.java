...
public class EquipementPDFExporter {
    ...
    public EquipementPDFExporter(java.util.List<Equipement> equipementList) {
    ...
    public void export(HttpServletResponse response) throws DocumentException, IOException {
        ...
        table.setWidthPercentage(100f);table.setWidths(new float[] {1.5f,1.5f,1.5f,2f,2f,2f,2f});

...
public class PiecePDFExporter1Element {

    private PieceRechange pieceRechange;
    public PiecePDFExporter1Element(PieceRechange pieceRechange){
    ...
    public void export(HttpServletResponse response) throws DocumentException, IOException {
        ...
        Paragraph p = new Paragraph("\n\nInformations sur la pièce "+pieceRechange.getNom_piece(), font);

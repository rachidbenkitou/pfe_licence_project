...
public class MaterielPDFExporter1Element {

    private Materiel materiel;
    public MaterielPDFExporter1Element(Materiel materiel){
    ...
    public void export(HttpServletResponse response) throws DocumentException, IOException {
        ...
        Paragraph p = new Paragraph("\n\nInformations sur le materiel "+materiel.getNom_materiel(), font);

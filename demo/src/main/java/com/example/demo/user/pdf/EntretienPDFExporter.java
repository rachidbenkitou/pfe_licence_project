...
public class EntretienPDFExporter {
    private List<User> userList;



    public EntretienPDFExporter(List<User> userList) {
    ...
    private void writeTableData(PdfPTable table) throws BadElementException, IOException {
        ...
        for (User user : userList) {
            ...
            table.addCell(new Phrase(String.valueOf(user.getPassword()),font));
    ...
    public void export(HttpServletResponse response) throws DocumentException, IOException {
        ...
        table.setWidthPercentage(100f);table.setWidths(new float[] {0.9f,1.5f,1.5f,1.5f,1.5f,1.5f,1.5f,1.5f,2f,2f});

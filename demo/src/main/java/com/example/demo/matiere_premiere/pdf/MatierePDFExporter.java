package com.example.demo.matiere_premiere.pdf;
...
public class MatierePDFExporter {
    private List<MatierePremiere> matierePremiereList;



    public MatierePDFExporter(java.util.List<MatierePremiere> matierePremiereList) {
        this.matierePremiereList = matierePremiereList;
    }
    ...
    private void writeTableData(PdfPTable table) throws BadElementException, IOException {
        ...
        for (MatierePremiere matierePremiere : matierePremiereList) {
            table.addCell(new Phrase(String.valueOf(matierePremiere.getId_matiere()),font));
            table.addCell(new Phrase(matierePremiere.getNom_matiere(),font));
            table.addCell(new Phrase(matierePremiere.getDesignation_matiere(),font));
            table.addCell(new Phrase(String.valueOf(matierePremiere.getPrix_matiere()),font));
            table.addCell(new Phrase(String.valueOf(matierePremiere.getQuantite_matiere()),font));
            table.addCell(new Phrase(matierePremiere.getDate_recu_matiere(),font));
        }
    }
    ...
    public void export(HttpServletResponse response) throws DocumentException, IOException {
        ...
        Paragraph p = new Paragraph("\n\nLa liste des matiéres premiéres", font);
        ...
        table.setWidthPercentage(100f);table.setWidths(new float[] {1.5f,1.5f,1.5f,1.5f,2f,2f});

...
public class MatierePDFExporter1Element {

    private MatierePremiere matierePremiere;
    public MatierePDFExporter1Element(MatierePremiere matierePremiere){
    ...
    public void export(HttpServletResponse response) throws DocumentException, IOException {
        ...
        Paragraph p = new Paragraph("\n\nInformations sur la matiére première "+matierePremiere.getNom_matiere(), font);
